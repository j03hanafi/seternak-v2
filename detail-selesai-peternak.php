<?php
    ...
    left join public.user on mitra.id_pemilik=public.user.username where peternak.id_peternak='$username'AND detail_pemesanan.status='4' AND pemesanan.no_pemesanan='$id' ORDER BY pemesanan.tgl_pesan");
    ...
    if($cek > 0){   
        ...
        echo 'window.location.href = " so-selesai-peternak.php";';
        echo '</script>';
    }else{
        // echo '<script>'; 
