...
<!-- Footer end -->
    ...
    <script>
        $(document).ready(function() {
            ...
            let base_url = "https://seternak.azurewebsites.net/function/chart-dashboard.php";
            $.ajax({
                url: base_url,
                dataType: 'json',
                cache: false,
            ...
            let url = "https://seternak.azurewebsites.net/function/doughnut-chart-dashboard.php";
            $.ajax({
                url: url,
                dataType: 'json',
                cache: false,
