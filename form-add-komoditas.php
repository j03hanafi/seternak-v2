...
<html lang="en">
  ...
  <!-- Navbar -->
    ...
    <form action="function/add-komoditas.php" method="post">

    <div class="row">
        <div class="col-md-12 mt-5 mb-5">
          <div class="card shadow-sm bg-body rounded">
            <div class="card-header shadow-sm bg-body rounded" style="background-color: white;">
              <div class="card-title ps-3 fw-bold">Form Tambah Harga Komoditas</div>
            </div>
            <div class="card-body">
              <div class="row">
                    <div class="mb-3 pe-5 ps-5">
                    <label for="nama_komoditas" class="form-label">Nama Komoditas</label>
                    <input type="text" class="form-control" id="nama_komoditas" name="nama_komoditas" placeholder="" required>
                    </div>

                    <div class="mb-3 pe-5 ps-5">
                    <label for="harga_komoditas" class="form-label">Harga (Rupiah)</label>
                    <input type="number" class="form-control" id="harga_komoditas"name="harga_komoditas" placeholder="" required>
                    </div>

                    <div class="mb-3 pe-5 ps-5">
                    <label for="satuan_komoditas" class="form-label">Satuan</label>
                    <input type="text" class="form-control" id="satuan_komoditas" name="satuan_komoditas" placeholder="" required>
                    </div>
              </div>
