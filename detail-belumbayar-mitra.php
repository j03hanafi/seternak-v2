        ...
        <div class="card text-center">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link order active" aria-current="true" href="so-belumbayar-mitra.php">Belum
                            dibayar</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="card-body">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="input-wrapper ">
                                ...
                                <input type="text" class="form-control" id="no_rek" name="no_rek"
                                    value="<?php echo $data->no_rek; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <?php endwhile; ?>
                ...
                <div class="card" style="padding:10px;">
                    ...
                    <div class="container">
                        <div class="row g-0">
                            ...
                            <div class="col-md-6" style="margin-top:20px;">
                                <img id="image" class="rounded float-start" src="assets/produk/<?=$data->foto_produk?>"
                                    alt="">
                                <h6 id="left" class="card-title">Kode :
                                    <?=$data->id_produk?><?php $id_produk=$data->id_produk ?></h6>
                            ...
                            <div class="col">
                                ...
                                <button class="btn btn-outline-success" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal<?php echo $id_produk; ?>" style="float:right;"
                                    type="button">
                                    Konfirmasi Pembayaran
                                </button>
                                <?php }else{ ?>
                                <button class="btn btn-outline-success" data-bs-toggle="modal"
                                    data-bs-target="#buktiPembayaran<?php echo $id_produk; ?>" style="float:right;"
                                    type="button">
                                    Lihat Bukti Pembayaran
                                </button>
                                <div class="modal fade" id="buktiPembayaran<?php echo $id_produk; ?>" tabindex="-1"
                                    aria-labelledby="buktiPembayaranLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">

                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="buktiPembayaranLabel">Bukti Transfer</h5>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal<?php echo $id_produk; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="function/upload_bukti.php" method="post"
                                        enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <input type="hidden" class="form-control" id="exampleFormControlInput1"
                                                name="id_produk" value="<?=$id_produk?>">
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input class="btn btn-success" type="submit" id="inputGroupFileAddon04"
