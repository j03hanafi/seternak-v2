    ...
    <div class="container"style="padding-top:100px;padding-bottom:5%;min-height:71.3vh;"> 
        <div class="card text-center">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link order active" aria-current="true" href="so-belumbayar-peternak.php">Belum dibayar</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-body">
                            ...
                            <?php while($image = pg_fetch_object($images)): ?>
                                ...
                                <img src="upload/<?=$image->bukti_pembayaran?>" class="d-block w-100" alt="...">
                                <?php 
                                    }else{
                                ?>
