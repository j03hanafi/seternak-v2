<?php
    ...
    left join public.user on mitra.id_pemilik=public.user.username where peternak.id_peternak='$username'AND detail_pemesanan.status='2' AND pemesanan.no_pemesanan='$id' ORDER BY pemesanan.tgl_pesan");
    ...
    <div class="container"style="padding-top:100px;padding-bottom:5%;min-height:71.3vh;"> 
        <div class="card text-center">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link order active" href="so-pengemasan-peternak.php">Perlu Dikemas</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="inlineCheckbox1" name="restatus" value="2" checked>
                                <label class="form-check-label" for="inlineCheckbox1">Belum</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="inlineCheckbox2" name="restatus" value="3">
